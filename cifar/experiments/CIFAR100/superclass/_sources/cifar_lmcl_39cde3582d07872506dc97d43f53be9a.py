...
class TrainingHarness(object):
    ...
    def _load_checkpoint(self, resume):
        ...
        if resume:
            ...
            self.optimizer['nn'].load_state_dict(checkpoint['optimizer_nn'])
            self.optimizer['centers'].load_state_dict(checkpoint['optimizer_centers'])
    ...
    def run(self, _log, device, resume, checkpoint_dir, evaluate, num_epochs):
        ...
        for epoch in range(self.start_epoch, num_epochs):
            ...
            self._save_checkpoint({
                ...
                'optimizer_centers': self.optimizer['centers'].state_dict(),
            }, is_best)
