...
class DenseNet(nn.Module):
    ...
    def __init__(self, depth=22, block=Bottleneck,
                 dropRate=0, num_classes=10, growthRate=12, compressionRate=2, embeddings=False):
        ...
        self.emb_fc = nn.Linear(self.inplanes, 2)
