...
DF_NIH = pd.read_csv("/dfs/scratch1/senwu/mmtl/emmental-tutorials/chexnet/data/nih_labels.csv").set_index("Image Index")
...
slicing_function_dict.update({"Abnormal": abnormal_slice_dict})
